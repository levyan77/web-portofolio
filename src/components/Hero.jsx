  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="mt-12 ml-4 md:ml-12 flex flex-col gap-6 relative z-10"
      >
        <div className="bg-white text-black p-4 inline-block font-black text-xl md:text-2xl transform md:skew-x-[-15deg] shadow-[5px_5px_0px_black] border-2 border-black max-w-[90vw] md:max-w-max">
